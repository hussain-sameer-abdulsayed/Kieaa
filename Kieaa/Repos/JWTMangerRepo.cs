...
{
    public class JWTMangerRepo : IJWTMangerRepo
    {
        ...
        public JWTMangerRepo(IConfiguration configuration, UserManager<IdentityUser> userManager, Context context, RoleManager<IdentityRole> roleManager)
        {
